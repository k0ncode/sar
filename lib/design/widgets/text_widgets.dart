...
TextStyle linkTextStyle(context) => Theme.of(context).textTheme.bodyText2!.copyWith(fontSize: 16, color: sarBlue, decoration: TextDecoration.underline);
...
class ArticleImage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ClipRRect(
          child: Image.asset("assets/images/image" + imageNumber + ".jpg", fit: BoxFit.fitWidth),
